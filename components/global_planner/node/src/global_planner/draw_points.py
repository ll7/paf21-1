"""Script to draw the global planner points on the carla town."""
import carla
...
x = [151.0201317777701, 151.07926120004393, 151.10204015194478, 148.50182665159923,
     147.4749138357087, 144.23591009984736, 143.5852898520519, 140.47595558397114,
     138.70656948959413, 138.5366284522811, 138.62880268980723, 94.12424397700269,
     90.35912903597337, 84.24546796806743, 81.6406182541614, 83.02911777156176,
     83.02911777156176, 83.11314179063645, 83.11856761930079, 80.39256248632665,
     73.33581213024362, 73.181824767485, 71.15196323802739, 70.80204352614126]
y = [62.77440875016973, 66.17389455120221, 67.4835086243901, 70.21767324165724,
     70.25138800502465, 70.34722234490702, 70.36436269707242, 70.44627696969977,
     70.49289079839156, 70.49736783278568, 73.99615389511308, 75.16861019644556,
     75.26780077074915, 77.37459103506083, 82.78022497434345, 122.06733198799145,
     122.06733198799145, 124.44476214748148, 124.59828406715253, 131.82042645729183,
     134.95086402363816, 134.95416290284246, 134.99764873094657, 135.00514507895872]

list_waypoints = [{'x': 168.08001031270084, 'y': 0.04306259308466573},
                  {'x': 290.36387436468766, 'y': 0.03001132617077165},
                  {'x': 290.5761280623479, 'y': 0.029943620852621165},
                  ...
                  {'x': 336.8649069019425, 'y': -57.96998940621726},
                  {'x': 336.85980300963956, 'y': -66.41998786481378},
                  {'x': 336.8585949877927, 'y': -68.41998749998453},
                  {'x': 336.8582265411294, 'y': -69.02998738871162},
                  {'x': 336.82708977802673, 'y': -120.57997798523826},
...
for point in list_waypoints:
    ...
    draw_waypoint(carla_point, TIME_2_LIFE)
...
draw_waypoint_first(carla_point, TIME_2_LIFE)

carla_point = carla.Location(x=last_point['x'], y=-last_point['y'], z=Z_AXIS)
draw_waypoint_last(carla_point, TIME_2_LIFE)
